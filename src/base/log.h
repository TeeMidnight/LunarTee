...
#define LOG_COLOR_INFO LOG_COLOR{0, 155, 255}
#define LOG_COLOR_SUCCESS LOG_COLOR{0, 155, 55}
#define LOG_COLOR_ERROR LOG_COLOR{255, 55, 55}
#define LOG_COLOR_WARNING LOG_COLOR{155, 155, 0}
